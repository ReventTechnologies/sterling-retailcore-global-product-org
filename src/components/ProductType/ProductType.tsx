...
import { saveProductTypeName } from 'Redux/actions/ProductCategories/ProductCategories'
...
export const ProductType = ({ product, index, currentEditId, productIndex, setCurrentEditId, updateProductTypeName }: Props) => {
  ...
  const onSaveChange = useCallback(
    (value?: string, key?: string) => {
      try {
        saveProductTypeName(product.product_type_id, value)

        console.log('saved', productIndex, product.product_type_id, index, value, name)
        saveProductTypeName(product.product_type_id, value)
        test()
        if (key === 'Enter') {
  ...
  // const onSaveChange = (value?: string, key?: string) => {
  //   console.log('save', productIndex, product.product_type_id, index, value, name, key)
  //   saveProductTypeName(product.product_type_id, value)
  ...
  //     updateProductTypeName(productIndex, product.product_type_id, index, value)
  //   } else {
  //     // saveProductTypeName(product.product_type_id, name)
  //     updateProductTypeName(productIndex, product.product_type_id, index, name)
  //   }
  //   // console.log(name)
  //   // setAllowEdit(false)
